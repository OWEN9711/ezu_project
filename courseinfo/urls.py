...
from courseinfo.views import (
    InstructorList, SectionList, CourseList, RegistrationList, StudentList, SemesterList, InstructorDetail,
    SectionDetail, SemesterDetail, StudentDetail, CourseDetail, RegistrationDetail, InstructorCreate, SectionCreate,
    CourseCreate, StudentCreate, RegistrationCreate, SemesterCreate, InstructorUpdate, CourseUpdate, RegistrationUpdate,
    StudentUpdate, SemesterUpdate, SectionUpdate, RegistrationDelete, InstructorDelete, CourseDelete, SemesterDelete, SectionDelete,
StudentDelete
)
...
urlpatterns = [
    ...
    path('instructor/create/', InstructorCreate.as_view(),
         name='courseinfo_instructor_create_urlpattern'),

    path('section/create/', SectionCreate.as_view(),
    ...
    path('semester/create/', SemesterCreate.as_view(),
         name ='courseinfo_semester_create_urlpattern'),

    path('instructor/<int:pk>/update/', InstructorUpdate.as_view(),
    ...
    path('registration/<int:pk>/update', RegistrationUpdate.as_view(),
    ...
    path('section/<int:pk>/update', SectionUpdate.as_view(),
         name='courseinfo_section_update_urlpattern'),

    path('semester/<int:pk>/update/', SemesterUpdate.as_view(),
         name='courseinfo_semester_update_urlpattern'),

    path('registration/<int:pk>/delete/', RegistrationDelete.as_view(),
         name='courseinfo_registration_delete_urlpattern'),

    path('instructor/<int:pk>/delete/', InstructorDelete.as_view(),
    ...
    path('section/<int:pk>/delete', SectionDelete.as_view(),
         name='courseinfo_section_delete_urlpattern'),

    path('semester/<int:pk>/delete', SemesterDelete.as_view(),
